...
if (isel==1.or.isel==3.or.isel==5) then
    if (irdfreq==0) then
        ...
        write(ides,"(a,/)") " Note: This is well known that the sign of hyperpolarizability of Gaussian 09 should be multiplied by -1, the outputs below have already been corrected"
        hypoltens=-hypoltens
        !Convert to other unit
