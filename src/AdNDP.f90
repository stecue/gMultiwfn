...
character :: c80tmp*80,c80tmp2*80,c200tmp*200,c1000tmp*1000,selectyn,fchfilename*80=' '
...
!     write(*,"(a)") "15 Output current density matrix to DMNAO.txt in current folder" !Rarely used, screen it to cut down list length
    write(*,"(a)") " 16 Output energy of picked AdNDP orbital"
    read(*,*) isel
    ...
    if (isel==-10) then
        ...
        if (.not.allocated(Fmat)) then
            ...
            read(10,*) ((Fmat(i,j),j=1,i),i=1,nbasis)
