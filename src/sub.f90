    ...
    if (iselect==-1) then
        ...
        do i=1,nmo
            ...
            if (allocated(MOsym)) then
                write(*,"(' Orb:',i6,' Ene(au/eV):',f13.6,f13.4,' Occ:',f9.6,' Type: ',a,' (',a,')')") i,MOene(i),MOene(i)*au2eV,MOocc(i),trim(orbtype),trim(MOsym(i))
            else
                write(*,"(' Orb:',i6,' Ene(au/eV):',f13.6,f13.4,' Occ:',f9.6,' Type: ',a)") i,MOene(i),MOene(i)*au2eV,MOocc(i),trim(orbtype)
            end if
        end do
        ...
        if (isetmode==1) then
            ...
            do iGTF=ind1,ind2
                if (b(iGTF)%center>=iatm1.and.b(iGTF)%center<=iatm2) then
                    if (seltmpc=="ALL".or.seltmpc=="all".or.GTFtype2name(b(iGTF)%functype)==trim(seltmpc).or.type2ang(b(iGTF)%functype)==trim(seltmpc)) then
...
call loclabel(20,'iloadasCart=')
read(20,*) c80tmp,iloadasCart
