...
write(*,"(' The highest angular moment basis functions is ',a)") shtype2name(maxval(abs(shelltype))) 
isphergau=0
...
ifiletype=2
imodwfn=0
iORCA=0 !Assume this is not a ORCA .wfn file
open(10,file=name,access="sequential",status="old")
read(10,"(a)") wfntitle
...
else !This .wfn file is probably generated by Windows version of ORCA, special treatment is employed since it is non-standard
    read(10,"(10x,5D14.7)") (b(i)%exp,i=1,nprims)
    iORCA=1
end if
