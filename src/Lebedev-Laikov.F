       subroutine Lebedevgen(npt,potx,poty,potz,potw)
       integer npt,isphnum
       real*8 potx(npt),poty(npt),potz(npt),potw(npt)
       if (npt==6) then
            call LD0006(potx,poty,potz,potw,isphnum)
       else if (npt==14) then
            call LD0014(potx,poty,potz,potw,isphnum)
       else if (npt==26) then
            call LD0026(potx,poty,potz,potw,isphnum)
       else if (npt==38) then
            call LD0038(potx,poty,potz,potw,isphnum)
       else if (npt==50) then
            call LD0050(potx,poty,potz,potw,isphnum)
       else if (npt==74) then
            call LD0074(potx,poty,potz,potw,isphnum)
       else if (npt==86) then
            call LD0086(potx,poty,potz,potw,isphnum)
       else if (npt==110) then
            call LD0110(potx,poty,potz,potw,isphnum)
       else if (npt==146) then
            call LD0146(potx,poty,potz,potw,isphnum)
       else if (npt==170) then
            call LD0170(potx,poty,potz,potw,isphnum)
       else if (npt==194) then
            call LD0194(potx,poty,potz,potw,isphnum)
       else if (npt==230) then
            call LD0230(potx,poty,potz,potw,isphnum)
       else if (npt==266) then
            call LD0266(potx,poty,potz,potw,isphnum)
       else if (npt==302) then
            call LD0302(potx,poty,potz,potw,isphnum)
       else if (npt==350) then
            call LD0350(potx,poty,potz,potw,isphnum)
       else if (npt==434) then
            call LD0434(potx,poty,potz,potw,isphnum)
       else if (npt==590) then
            call LD0590(potx,poty,potz,potw,isphnum)
       else if (npt==770) then
            call LD0770(potx,poty,potz,potw,isphnum)
       else if (npt==974) then
            call LD0974(potx,poty,potz,potw,isphnum)
       else if (npt==1202) then
            call LD1202(potx,poty,potz,potw,isphnum)
       else if (npt==1454) then
            call LD1454(potx,poty,potz,potw,isphnum)
       else if (npt==1730) then
            call LD1730(potx,poty,potz,potw,isphnum)
       else if (npt==2030) then
            call LD2030(potx,poty,potz,potw,isphnum)
       else if (npt==2354) then
            call LD2354(potx,poty,potz,potw,isphnum)
       else if (npt==2702) then
            call LD2702(potx,poty,potz,potw,isphnum)
       else if (npt==3074) then
            call LD3074(potx,poty,potz,potw,isphnum)
       else if (npt==3470) then
            call LD3470(potx,poty,potz,potw,isphnum)
       else if (npt==3890) then
            call LD3890(potx,poty,potz,potw,isphnum)
       else if (npt==4334) then
            call LD4334(potx,poty,potz,potw,isphnum)
       else if (npt==4802) then
            call LD4802(potx,poty,potz,potw,isphnum)
       else if (npt==5294) then
            call LD5294(potx,poty,potz,potw,isphnum)
       else if (npt==5810) then
            call LD5810(potx,poty,potz,potw,isphnum)
       else
          write(*,*) "Input error!"
          read(*,*)
       end if
