...
do
    echo $ifwrong
    wget 'http://sobereva.com/multiwfn/misc/Multiwfn_3.6_dev_src_Linux.zip' -O $LATEST
...
wget 'http://sobereva.com/multiwfn/misc/Multiwfn_3.6_dev_bin_Win64.rar' -O examples.rar
EOF
