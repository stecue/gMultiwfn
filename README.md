...
# Binary Packages
RPM packages for openSUSE, Fedora and CentOS are built on the OBS platform (thanks to openSUSE!) and the download page is: https://software.opensuse.org//download.html?project=home%3Astecue%3AgMultiwfn&package=gMultiwfn.
