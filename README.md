...
The source tarball can be found [here](https://github.com/stecue/gMultiwfn/releases). Please use the link displayed as **[gMultiwfn-3.4.0-0.tar.gz](https://github.com/stecue/gMultiwfn/releases/download/v3.4.0-0/gMultiwfn-3.4.0-0.tar.gz)**, not the links displayed as
...
2. Unzip and extract files from the source tarball. If the name of the tarball is `gMultiwfn-3.4.0-1.tar.gz`, the command would be:
```bash
